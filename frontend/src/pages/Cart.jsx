...
export const Cart = () => {
    ...
    const handleRemoveItem = async (bookid) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_BACK_URL}/api/Cart`, {
                method: 'PUT',
                headers: {
    ...
    const handleQuantityChange = async (bookid, action) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_BACK_URL}/api/updatequantity`, {
                method: 'PUT',
                headers: {
                    authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
            ...
            showAlert("No more quantity available for this book ","error");
        }
    };
                                        ...
                                        {item && (
                                            <>
                                                ...
                                                <div className="item-details">
                                                    ...
                                                    {item.Author && (
                                                        <p className="item-author"><b>Author : </b> {item.Author}</p>
                                                    )}
                                                </div>
                                            </>
                                        )}
