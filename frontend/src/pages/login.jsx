...
const token = Cookies.get("token");
  ...
  const handleSendOtp = async (event) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACK_URL}/api/registerotp`, {
        method: "POST",
        headers: {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACK_URL}/api/verifyotp`, {
        method: "POST",
        headers: {
          authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const HandleLog = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACK_URL}/api/login`, {
        method: "POST",
        headers: {
          authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
